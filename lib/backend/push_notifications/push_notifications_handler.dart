...
import '../../main.dart';
import '../../sign_in_phone/sign_in_phone_widget.dart';
import '../../verify_phone/verify_phone_widget.dart';
import '../../capture1/capture1_widget.dart';
...
final pageBuilderMap = <String, Future<Widget> Function(Map<String, dynamic>)>{
  'signInPhone': (data) async => SignInPhoneWidget(),
  'verifyPhone': (data) async => VerifyPhoneWidget(),
  'capture1': (data) async => Capture1Widget(),
  'capture2': (data) async => Capture2Widget(
        moodValue: getParameter(data, 'moodValue'),
        ae: getParameter(data, 'ae'),
      ),
};
